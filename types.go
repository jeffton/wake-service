...
type Forecast struct {
	...
	Precipitation1Hour       *float64    `json:"precipitation1hour,omitempty"`
	PrecipitationAmount1Hour *float64    `json:"precipitationAmount1hour,omitempty"`
...
type ForecastUnits struct {
	...
	Precipitation1Hour       string `json:"precipitation1hour"`
	PrecipitationAmount1Hour string `json:"precipitationAmount1hour"`
